...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (StringUtils.hasText(token) && jwtGenerador.validarToken(token)) {
            ...
            String username = (String) jwtGenerador.obtenerClaimsDeJwt(token, "subject");
            //Luego creamos el objeto userDetails el cual contendrá todos los detalles de nuestro username, o sea nombre, pw y roles segun el método loadUserByUsername
